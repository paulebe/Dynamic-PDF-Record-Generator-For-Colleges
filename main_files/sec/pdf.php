<?php 
 ...
 if(($pdfile=="BONAFIDE_PAGE")||($pdfile=="INDEX_PAGE")||($pdfile=="FRONT_PAGE")||($pdfile=="BATCH_2_INDEX"))  
{ 
    $gname=isset($_SESSION['name'])?$_SESSION['name']:'AAAA';
 logger($gname.'#'.$ip."#SEC_LAB#".$pdfile."#".$m."#".date('M d-y#l#h:i:s a')."#DOWNLOAD");
...
if($red=='00')
{
 ...
 $mo="DOWNLOAD";
  $_SESSION['name']=$gname;
  logger($gname.'#'.$ip."#SEC_LAB#".$pdfile."#".$m."#".date('M d-y#l#h:i:s a')."#$mo");

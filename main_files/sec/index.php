...
<div class="w3-topnav w3-large w3-green" style="text-align: center">
    &nbsp;
    <button class="w3-btn w3-green w3-border w3-border-white w3-text-aqua w3-round-large" onClick="window.location.href='../' ">GCC-LAB</button>&nbsp;
    <!-- <button class="w3-btn w3-green w3-border w3-border-white w3-text-aqua w3-round-large" onClick="window.location.href='../softskills/'">SOFT_SKILLS LAB</button>  -->

    &nbsp;<span class="auto-style7" style="text-transform:uppercase">&nbsp;CS6711 Security Laboratory-IV CSE</span><span class="auto-style1">&nbsp;</span></div>
...
&nbsp;&nbsp;
    ...
    <div class="w3-col m2 w3-light-grey w3-padding">
      ...
      <div class="w3-left-align" style="height: 427px">
          <strong><em>
         <marquee onmouseover="this.stop();" onmouseout="this.start();" direction="up" scrollamount="3" style="height: 418px" scrolldelay="100"><?php require_once('../notice_common.php');echo "<center>---SEC---</center>".$sec."<center><br>---GCC---</center>".$gcc; ?></marquee></em></strong></div>
    </div>
  </div>
</div>
  ...
  <div class="w3-modal-content w3-card-8 w3-animate-zoom" style="max-width:600px; left: 9px; top: -83px;">
    ...
    <div class="w3-container">
      <div class="w3-section">
        <label><b>You're Redg.No:</b></label><div class="w3-input"><b><span class="auto-style12">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="auto-style5">&nbsp;4116151040</span><strong><select id="rn" name="r_no" onchange="onse();"style="width: 66px; height: 35px"  class="auto-style4">
	...
	16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>
